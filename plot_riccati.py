...
legend_elements = [
    (Line2D([0], [0], color=plotting.mix(C0, 80), lw=1.5), "$W_2^8$"),
    (Line2D([0], [0], color=plotting.mix(C1, 80), lw=1.5), "$B_4(W_2^8)$"),
    (Line2D([0], [0], color=plotting.mix(C2, 80), lw=1.5), "$T_6(V_3^8)$")
]
